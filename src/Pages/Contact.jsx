...
const Contact = () => {
    return (
        <div>
            ...
            <div className='bg-base-100 p-5 rounded-xl shadow-xl w-screen lg:w-[31%]'>
                ...
                <form>
                   ...
                   <textarea className='p-3 w-full border border-blue-500 rounded-lg' name="" id="" placeholder='write Your Message / Suggetion / Complain / Advice please.' rows="8"></textarea>
